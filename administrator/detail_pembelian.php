								...
								<tr>
									...
									<td>
										<form action="simpan_barang_beli.php" method="post">
											<div class="form-group">
												...
												<select name="ProdukID" class="form-control" onchange="this.form.submit()" disabled>
									...
									<td>
										<form method="post" action="hitung_subtotal.php">
											...
											?>
											<div class="form-group">
												<input type="number" name="JumlahProduk" value="<?php echo $d_detailpenjualan['JumlahProduk']; ?>" class="form-control" disabled>
											</div>
									</td>
									...
									<td>
										<div class="d-flex gap-2">
											<input type="text" name="DetailID" value="<?php echo $d_detailpenjualan['DetailID']; ?>" hidden>
											<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
											<button type="submit" class="btn btn-warning btn-sm" disabled><i class="bi bi-check-circle"></i> Proses</button>
											</form>
											<form method="post" action="hapus_detail_pembelian.php">
												<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
												<input type="text" name="DetailID" value="<?php echo $d_detailpenjualan['DetailID']; ?>" hidden>
												<button type="submit" class="btn btn-danger btn-sm" disabled><i class="bi bi-trash"></i> Hapus</button>
											</form>
										</div>
									</td>
								</tr>
					...
					<div class="row">
						<div class="col-sm-10">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="TotalHarga" value="<?php echo $sum; ?>" disabled>
								<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
								<input type="text" name="PenjualanID" value="<?php echo $d['PenjualanID']; ?>" hidden>
							</div>
							<div class="form-group">
								<label>Uang Pembayaran</label>
								<input type="number" class="form-control" name="UangBayar" placeholder="<?php echo $d['UangBayar']; ?>" required disabled>
							</div>
						</div>
						...
						<div class="col-sm-2">
							<div class="form-group">
								<label for=""></label>
								<button class="btn btn-info btn-sm form-control" type="submit" disabled><i class="bi bi-save"></i> Simpan</button>
							</div>
						</div>
					</div>
				</form>
