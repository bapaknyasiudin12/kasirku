			...
			<div class="col-sm-4">
				<div class="card">
					<div class="card-body">
						...
						<a href="data_pengguna.php" class="btn btn-outline-primary btn-sm"><i class="bi bi-file-text"></i> Detail</a>
					</div>
				</div>
			</div>
		</div>
...
<div class="card mt-2">
	<div class="card-body">
		<p>Hi!, <?php echo $_SESSION['nama_petugas']; ?>. Selamat Datang di Halaman Admin!</p>
	</div>
</div>
<?php
include "footer.php";
